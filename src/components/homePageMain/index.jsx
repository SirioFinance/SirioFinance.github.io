...
import "./style.css";
const SecondContainer = React.lazy(() =>
	import("../homepageContainers/secondContainer")
);
const ThirdContainer = React.lazy(() =>
	import("../homepageContainers/thirdContainer")
);
const FourthContainer = React.lazy(() =>
	import("../homepageContainers/fourthContainer")
);
const FifthContainer = React.lazy(() =>
	import("../homepageContainers/fifthContainer")
);
const SixthContainer = React.lazy(() =>
	import("../homepageContainers/sixthContainer")
);
