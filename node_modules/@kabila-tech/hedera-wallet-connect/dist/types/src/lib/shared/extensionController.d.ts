...
export declare const findExtensions: (ids: string[], onFound: (_metadata: ExtensionData, isFrame: boolean) => void) => void;
export declare const extensionQuery: (id: string) => void;
