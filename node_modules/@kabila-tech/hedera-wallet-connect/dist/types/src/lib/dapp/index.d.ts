...
export declare class DAppConnector {
     ...
     */
    constructor(metadata: SignClientTypes.Metadata, network: LedgerId, projectId: string, methods?: string[], events?: string[], chains?: string[], extensionIds?: string[]);
    ...
    checkPersistedState(): SessionTypes.Struct[];
     ...
     * ```
     */
    executeTransaction(params: ExecuteTransactionParams): Promise<ExecuteTransactionResult['result']>;
    /**
     ...
     * ```
     */
    executeTransaction(accountId: AccountId, transaction: Transaction): Promise<ExecuteTransactionResult['result']>;
    /**
     ...
     * ```
     */
    signMessage(params: SignMessageParams): Promise<SignMessageResult['result']>;
    signMessage(accountId: AccountId, message: string): Promise<SignMessageResult['result']>;
    /**
     ...
     * ```
     */
    signAndExecuteQuery(params: SignAndExecuteQueryParams): Promise<SignAndExecuteQueryResult['result']>;
    signAndExecuteQuery(accountId: AccountId, query: string): Promise<SignAndExecuteQueryResult['result']>;
    /**
     ...
     * ```
     */
    signAndExecuteTransaction(params: SignAndExecuteTransactionParams): Promise<SignAndExecuteTransactionResult['result']>;
    signAndExecuteTransaction(accountId: AccountId, transaction: Transaction): Promise<SignAndExecuteTransactionResult['result']>;
    /**
     * Signs and executes Transactions on the Hedera network.
     *
     ...
     * ```
     */
    signTransaction(params: SignTransactionParams): Promise<SignTransactionResult['result']>;
